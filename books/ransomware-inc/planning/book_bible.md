...
Ransomware, Inc. is a narrative non-fiction account of how digital extortion stopped being a crime and became an industry. Drawing on five 2025–2026 threat-intelligence reports synthesizing dozens of primary sources — Check Point Research, Broadcom/Symantec, ENISA, AhnLab, Rapid7, Lyrie Threat Intelligence, BreachSense, Cisco Talos, Mandiant, the U.S. Treasury (FinCEN), NIST, Trend Micro, Zscaler ThreatLabz, NordStellar, BlackFog, Unit 42, GuidePoint Security (GRIT), Industrial Cyber, Semperis, and others — the book traces the maturation of ransomware from chaotic gang activity into a platform economy with brands, affiliate programs, white-label franchises, recruitment pipelines, negotiation desks, customer-service workflows, leak-site marketing operations, and, increasingly, agentic AI as the connective tissue.

The book's central argument is that ransomware in 2026 is best understood not as a malware category but as a business. Cybercriminals have built the operational scaffolding of a mid-cap services company: divisions for sales, supply chain, R&D, customer relations, marketing, HR, and legal pressure. The reader meets the platforms (Qilin, LockBit 5.0, Akira, DragonForce, The Gentlemen), the labor markets that feed them, the access brokers and infostealer crews who supply the inventory, the negotiators who close the deals, and the executives across the world who wake up one morning to find that their company has become the product being sold.
...
|----------|----------|-------------------|---------------------|
| 1 | task_1779005211_949b8650bc.md | Check Point Research, Broadcom/Symantec, AhnLab, Brandefense, GuidePoint Security (GRIT), Secure Blink | Q1 2026 RaaS market structure, victim concentration, dominant operators (Qilin, Akira, LockBit 5.0, The Gentlemen, DragonForce), white-label/cartel partnerships, affiliate economics |
| 2 | task_1779007686_c4a3e64a89.md | Rapid7, ENISA, BreachSense, Lyrie Threat Intelligence, Mandiant, Cisco Talos, DeepStrike, Huntress, NCC Group, Recorded Future | Cartels as digital employers; recruitment pipelines; labor partitioning between operators and affiliates; the infostealer-to-IAB-to-affiliate access economy; SSO/Entra ID credential markets; insider procurement |
| 3 | task_1779010243_15a209c49d.md | FinCEN (U.S. Treasury), Trend Micro, Zscaler ThreatLabz, ITBrief, NIST (FIPS 203), SoftwareSeni, Federal Reserve, Unit 42, ENISA | Payload evolution; modular extortion architecture; agentic AI and LLM-driven attack lifecycle automation; hyper-personalized social engineering; voice cloning and conversational extortion bots; post-quantum cryptography (ML-KEM/Kyber) in ransomware |
...
| 5 | task_1779014305_434487fb06.md | ENISA, GuidePoint, Industrial Cyber, Trend Micro, Blair Technology, Broadcom, Semperis, CISA, Nightwing, CYFIRMA | Strategic victimology; sector and geographic targeting (manufacturing, healthcare, digital infrastructure; Germany, Italy, Spain, France, Belgium); resilience-denial targeting of backups, Active Directory/Entra ID, ESXi hypervisors; edge-device exploitation (Fortinet, SonicWall, Palo Alto, Citrix); BYOVD and vulnerable-driver abuse; zero-day patch compression |
...
*   **Active Directory / Entra ID** = the building's master keycard system; whoever controls it controls who can open which door
*   **Hypervisors (ESXi)** = a single locked utility closet that powers the lights, HVAC, and elevators for an entire skyscraper
...
|---|-------|----------|---------------|-------------|-----------------------|
| 1 | The Cartel Year | How ransomware became a platform business | What does it mean that seven out of ten global ransomware victims now come from a handful of brands that do not legally exist? | Report #1, Report #4 | books/ransomware-inc/reports/task_1779005211_949b8650bc.md; books/ransomware-inc/reports/task_1779012482_285007975a.md |
...
| 3 | The Wholesalers | Infostealers, access brokers, and the supply chain of compromise | Who are the people quietly selling the keys to your company, and how does a twenty-dollar credential become a multi-million-dollar ransom? | Report #2 | books/ransomware-inc/reports/task_1779007686_c4a3e64a89.md |
...
| 7 | The Voice on the Phone | Deepfakes, hyper-personalized phishing, and the engineering of misplaced trust | What does social engineering look like when the attacker has read every email you have ever written, cloned your CFO's voice, and is calling your help desk on a Tuesday morning? | Report #3, Report #2 | books/ransomware-inc/reports/task_1779010243_15a209c49d.md; books/ransomware-inc/reports/task_1779007686_c4a3e64a89.md |
...
* **Ch 1:** Q1 2026 top-10 concentration (71%), top-four share (41%), Qilin volume (338 victims), 2,122 listed victims, LockBit 5.0 return (163 victims), The Gentlemen's breakout, year-over-year growth language. Source: Report #1, with corroborating volume language from Report #4 where natural.
* **Ch 2:** DragonForce white-label model and 80% affiliate split; RansomHub's prior 90% split before shutdown; LockBit 5.0 relaunch including the approximately $500 BTC affiliate deposit and multi-platform (Windows/Linux/ESXi) targeting; attempted DragonForce/LockBit/Qilin cartel signaling; the "equal competition conditions" rhetoric. Source: Report #1.
* **Ch 3:** Infostealer-to-IAB-to-affiliate pipeline; pricing ranges ($20 low-privilege credentials to $10,000+ for domain admin); 16% of infostealer-infected endpoints exposing enterprise SSO; 79% of logs containing Microsoft Entra ID credentials; 1.17 million logs containing credentials plus session cookies enabling MFA bypass; phishing reemerging as top initial vector (Cisco Talos Q1 2026); pre-ransomware engagement decline from 50% to 18%; rogue-insider recruitment (NCC Group). Source: Report #2.
* **Ch 4:** ENISA's 81.1% of cybercrime activity figure for ransomware; sector mix (manufacturing 14.9% of ransomware claims, digital infrastructure & services 10.3%; digital infrastructure 28.2% and public administration 16.8% for data-breach claims); country mix (Germany 23.4%, Italy 11.33%, Spain 9.8%, France 9.5%, Belgium 3.7%); healthcare impact on medical procedures. Source: Report #5.
* **Ch 5:** ESXi zero-day live exploitation into January 2026; Active Directory / Entra ID compromise as a force-multiplier in successful ransomware; Clop's mass exploitation of Oracle E-Business Suite flaws; Akira's continued monetization of SonicWall vulnerabilities; edge-device exploitation rising from 3% to 22% of vulnerability-exploitation breaches (Trend Micro); BYOVD example (Baidu Antivirus driver / DeadLock); November 2025 Windows kernel EoP patch-cycle exploitation. Source: Report #5.
* **Ch 6:** Agentic-AI framing as decision support across the kill chain rather than autonomous attack; Trend Micro forecast of faster, more persistent automated ransomware; ITBrief 2026 fully-automated cybercrime forecast; Zscaler ThreatLabz vishing forecast; the FinCEN $2.1B in U.S. ransomware payments 2022–2024 as the economic engine; Unit 42 framing of business disruption. Source: Report #3.
* **Ch 7:** Zscaler ThreatLabz forecast of voice-based social engineering; hyper-personalized phishing pipeline (public data, breach corpora, social media, vendor relationships); conversational extortion bots and AI-managed negotiation; persona-simulation pipelines; SSO/Entra ID exposure framing as the credential target. Sources: Report #3 (primary), Report #2 (access economy context).
* **Ch 8:** 7,960 leak-site listings in 2025 (+53% YoY) — Check Point; 2,122 Q1 2026 victims; 256 negotiations / 11,599 messages / average 47 messages per negotiation (NordStellar); 25.6% payment rate; median 57% discount, up to 96.2% reduction; the $150K-to-$120K case with law-enforcement mention; data exfiltration in 96% of tracked incidents (BlackFog); $5.2M average demand in H1 2024; Change Healthcare ~$22M+ payment; Synnovis $50M demand; London Drugs $25M; Indian Regional Cancer Center $100M demand; SEC and regulatory disclosure leverage. Source: Report #4.
